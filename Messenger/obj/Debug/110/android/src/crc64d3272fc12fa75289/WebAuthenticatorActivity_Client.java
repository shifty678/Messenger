...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.Auth.WebAuthenticatorActivity+Client, Microsoft.WindowsAzure.Mobile.Ext", WebAuthenticatorActivity_Client.class, __md_methods);
	}
	...
	public WebAuthenticatorActivity_Client ()
	{
		...
		if (getClass () == WebAuthenticatorActivity_Client.class)
			mono.android.TypeManager.Activate ("Xamarin.Auth.WebAuthenticatorActivity+Client, Microsoft.WindowsAzure.Mobile.Ext", "", this, new java.lang.Object[] {  });
	}

	public WebAuthenticatorActivity_Client (crc64d3272fc12fa75289.WebAuthenticatorActivity p0)
	{
		super ();
		if (getClass () == WebAuthenticatorActivity_Client.class)
			mono.android.TypeManager.Activate ("Xamarin.Auth.WebAuthenticatorActivity+Client, Microsoft.WindowsAzure.Mobile.Ext", "Xamarin.Auth.WebAuthenticatorActivity, Microsoft.WindowsAzure.Mobile.Ext", this, new java.lang.Object[] { p0 });
	}
